...
class ProjetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projet" do
    assert_difference('Projet.count') do
      post projets_url, params: { projet: { date: @projet.date, titre: @projet.titre, user_id: @projet.user_id } }
    end
  ...
  test "should update projet" do
    patch projet_url(@projet), params: { projet: { date: @projet.date, titre: @projet.titre, user_id: @projet.user_id } }
