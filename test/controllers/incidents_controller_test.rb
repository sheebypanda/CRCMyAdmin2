...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { commentaire: @incident.commentaire, debut: @incident.debut, fin: @incident.fin, idasap: @incident.idasap, idnxo: @incident.idnxo, user_id: @incident.user_id } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { commentaire: @incident.commentaire, debut: @incident.debut, fin: @incident.fin, idasap: @incident.idasap, idnxo: @incident.idnxo, user_id: @incident.user_id } }
