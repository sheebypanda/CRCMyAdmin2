class RecettesController < ApplicationController
  ...
  def dashboard
    @eqs = Equipement.select(:marque, :modele).where.not(marque: [nil, '', 'net-snmp', 'Unknown', 'Moxa Technologies Co., Ltd.', 'PipingHot Networks Limited', 'Aerohive'], 'equipements.nom' => 'Cimetière Chartreuse-Loge', nom: [nil, '']).distinct(:modele)
  end
